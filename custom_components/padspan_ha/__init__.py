...
Entry point. Initializes coordinator, stores, websockets, and registers the single panel. Defensive: any exceptions here can break config flow (gear icon).
"""
...
from .const import DATA_SETTINGS, DATA_MAPS
