...
import { SAMPLE_SNAPSHOT } from "./sample_data.js?b=20260224T204149Z";
import { HELP } from "./help_content.js?b=20260224T204149Z";
import * as Follow from "./views/follow.js?b=20260224T204149Z";
import * as Overview from "./views/overview.js?b=20260224T204149Z";
import * as Objects from "./views/objects.js?b=20260224T204149Z";
import * as Devices from "./views/devices.js?b=20260224T204149Z";
import * as Bluetooth from "./views/bluetooth.js?b=20260224T204149Z";
import * as Presence from "./views/presence.js?b=20260224T204149Z";
import * as Zones from "./views/zones.js?b=20260224T204149Z";
import * as Insights from "./views/insights.js?b=20260224T204149Z";
import * as History from "./views/history.js?b=20260224T204149Z";
import * as Monitor from "./views/monitor.js?b=20260224T204149Z";
import * as Maps from "./views/maps.js?b=20260224T204149Z";
import * as Events from "./views/events.js?b=20260224T204149Z";
import * as Health from "./views/health.js?b=20260224T204149Z";
import * as Settings from "./views/settings.js?b=20260224T204149Z";
import * as Manage from "./views/manage.js?b=20260224T204149Z";
import * as Debug from "./views/debug.js?b=20260224T204149Z";
import * as Diagnostics from "./views/diagnostics.js?b=20260224T204149Z";
import * as QA from "./views/qa.js?b=20260224T204149Z";
import * as Training from "./views/training.js?b=20260224T204149Z";
import * as Calibration from "./views/calibration.js?b=20260224T204149Z";
import * as Sandbox from "./views/sandbox.js?b=20260224T204149Z";
